defmodule PetClinicMx.Repo.Migrations.CreatePetTypesTable do
  ...
  def change do
    ...
    Enum.each(types, fn type ->
      query = "INSERT INTO pet_types (name, inserted_at, updated_at) VALUES ($1::character varying, $2, $3);"
